 ...
 * @LastEditors: 熊小兜
 * @LastEditTime: 2019-12-06 10:14:10
 -->
<template>
        ...
        <div class="bottom">
            <div class="content" @click="add" v-for="(book,index) in books" :key="index" >
                ...
                <div class="textbox" >
                    <span>{{book.name}}</span>
                    <p>{{book.center}}</p>
                    <p class="ptext">{{book.aut}}</p>
                    <div class="tiletype">{{book.tiletype}}</div>
